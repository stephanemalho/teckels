...
export default function MentionsLegalesPage() {
  const pageUrl = siteConfig.pages.legalNotice
  ...
  const webPageSchema = generateWebPageSchema({
    url: pageUrl,
    name: pageMetadata.legalNotice.title,
    description: pageMetadata.legalNotice.description,
    breadcrumbId,
        ...
        <div className="container mx-auto max-w-4xl space-y-10">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-1 text-muted-foreground">
              ...
              <p>Adresse du siège : commune de Dommartin-lès-Cuiseaux (71480) - France.</p>
              <p>Adresse complète communiquée uniquement après réservation.</p>
