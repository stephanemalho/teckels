...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: pageMetadata.presentation.title,
        description: pageMetadata.presentation.description,
        url: `${siteConfig.siteUrl}/presentation`,
        images: [{ url: `${siteConfig.siteUrl}${siteConfig.ogImage}` }],
    },
    alternates: {
        canonical: `${siteConfig.siteUrl}/presentation`,
    },
}
        ...
        <>
            ...
            <div className="py-16">
                <main id="main-content" className="container mx-auto">
                    ...
                    {/* Mission Section */}
                    <section className="mb-16" aria-labelledby="our-philosophy-header">
                    ...
                    {/* Approach Section */}
                    <section className="mb-16" aria-labelledby="our-approach-header">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
