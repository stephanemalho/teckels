      ...
      <div className="py-16">
        <main id="main-content" className="container mx-auto max-w-4xl space-y-10">
          <header className="space-y-3">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">Termes et conditions d&apos;utilisation</h1>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">3. Prise de contact et réservations</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">4. Obligations des utilisateurs</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">7. Liens externes et réseaux sociaux</h2>
            <p className="text-muted-foreground">
