            ...
            <div className="py-16">
                <div className="container mx-auto">
                        ...
                        <div className="relative h-64 md:h-96 rounded-lg overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                                <div className="text-white text-center space-y-4">
                                    <h1 id="bien-etre-animal" className="text-xl md:text-3xl font-bold">La vie en élevage</h1>
                    ...
                    <section className="text-center mb-16" aria-labelledby="portee-info">
                        <h2 id="portee-info" className="text-xl md:text-2xl font-bold mb-4">Première portée d&apos;Exotic Perle Teckel</h2>
                        ...
                        <section aria-labelledby="nursery">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div className="space-y-6">
                                    ...
                                    <h3 id="nursery" className="text-xl md:text-2xl font-bold">Un cocon dès la naissance</h3>
                        ...
                        <section className="bg-muted/30 -mx-4 px-4 py-16 rounded-lg" aria-labelledby="indoor-areas">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                ...
                                <div className="space-y-6 md:order-1">
                                    ...
                                    <h3 id="indoor-areas" className="text-xl md:text-2xl font-bold">Jeux d&apos;éveil et découvertes</h3>
                                    <p className="text-muted-foreground leading-relaxed">
                        ...
                        <section aria-labelledby="outdoor-areas">
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div className="space-y-6">
                                    ...
                                    <h3 id="outdoor-areas" className="text-xl md:text-2xl font-bold">Premières sorties encadrées</h3>
                                    <p className="text-muted-foreground leading-relaxed">
