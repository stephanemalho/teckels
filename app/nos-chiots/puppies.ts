...
const litterPerleMilo = {
    parents: "Parents : PERLE & MILO",
...
const puppiesUnsorted: Puppy[] = [
    ...
    },
    {
        ...
        size: "Kaninchen ou nain",
        ruler: "Poil ras",
        weight: litterPerleMilo.weight,
        parents: litterPerleMilo.parents,
        readyDate: litterPerleMilo.readyDate,
        age: litterPerleMilo.ageFemale,
        birthDate: litterPerleMilo.birthDate,
        updatedAt: puppiesUpdatedAt,
        description:
